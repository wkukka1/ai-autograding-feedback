...
from student_submission import calculate_statistics, classify_single_species  # Student's implementation
from instructor_solution import calculate_statistics as instructor_calculate_statistics, classify_single_species as instructor_classify_species  # Instructor's implementation
...
def test_sepal_length_mean():
    ...
    assert np.isclose(student_statistics['sepal_length_mean'], instructor_statistics['sepal_length_mean'], atol=0.1)

# Test sepal_width_mean
def test_sepal_width_mean():
    student_statistics = calculate_statistics(df)
    instructor_statistics = instructor_calculate_statistics(df)
    assert np.isclose(student_statistics['sepal_width_mean'], instructor_statistics['sepal_width_mean'], atol=0.1)

# Test sepal_length_std
def test_sepal_length_std():
    student_statistics = calculate_statistics(df)
    instructor_statistics = instructor_calculate_statistics(df)
    assert np.isclose(student_statistics['sepal_length_std'], instructor_statistics['sepal_length_std'], atol=0.1)

# Test sepal_width_std
def test_sepal_width_std():
    student_statistics = calculate_statistics(df)
    instructor_statistics = instructor_calculate_statistics(df)
    assert np.isclose(student_statistics['sepal_width_std'], instructor_statistics['sepal_width_std'], atol=0.1)

# Test sepal_length_median
def test_sepal_length_median():
    student_statistics = calculate_statistics(df)
    instructor_statistics = instructor_calculate_statistics(df)
    assert np.isclose(student_statistics['sepal_length_median'], instructor_statistics['sepal_length_median'], atol=0.1)

# Test sepal_width_median
def test_sepal_width_median():
    student_statistics = calculate_statistics(df)
    instructor_statistics = instructor_calculate_statistics(df)
    assert np.isclose(student_statistics['sepal_width_median'], instructor_statistics['sepal_width_median'], atol=0.1)

# Test sepal_length_var
def test_sepal_length_var():
    student_statistics = calculate_statistics(df)
    instructor_statistics = instructor_calculate_statistics(df)
    assert np.isclose(student_statistics['sepal_length_var'], instructor_statistics['sepal_length_var'], atol=0.1)

# Test sepal_width_var
def test_sepal_width_var():
    student_statistics = calculate_statistics(df)
    instructor_statistics = instructor_calculate_statistics(df)
    assert np.isclose(student_statistics['sepal_width_var'], instructor_statistics['sepal_width_var'], atol=0.1)
