...
class Prompt(Enum):
    ...
    IMAGE_OVERALL_WITH_INSTRUCTION = "image_overall_with_instruction"
    IMAGE_COMPARE_WITH_INSTRUCTION = "image_compare_with_instruction"
    ...
    CODE_OVERALL_WITH_INSTRUCTION = "code_overall_with_instruction"
