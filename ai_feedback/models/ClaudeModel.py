...
class ClaudeModel(Model):
    ...
    def _get_file_contents(self, file_path: Path) -> str:
        """
        Retrieves contents of the file and concatenates them with line numbers.

        Args:
           file_path: Path object to be parsed
